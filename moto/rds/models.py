...
class Database(BaseModel):
    ...
    def __init__(self, **kwargs):
        ...
        if self.db_parameter_group_name and self.db_parameter_group_name not in rds_backends[self.region].db_parameter_groups:
    ...
    def db_parameter_groups(self):
        if not self.db_parameter_group_name:
            ...
            return [rds_backends[self.region].db_parameter_groups[self.db_parameter_group_name]]
